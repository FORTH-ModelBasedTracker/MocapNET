...
std::vector<float> prepareMocapNETInputFromUncompressedInput(std::vector<float> input)
{
    ...
    if (rShoulderToHipDistance!=0)
       {
         scaleDistance=rShoulderToHipDistance;
       } else
    if (lShoulderToHipDistance!=0)
       {
    ...
    for (unsigned int iI=0; iI<MocapNETInputCompressedArrayIndexesSize; iI++)
    {
       ...
       for (unsigned int jJ=0; jJ<MocapNETInputCompressedArrayIndexesSize; jJ++)
       {
           ...
           } else
           {
              ...
              {
                 if (i==7) { iX=iX-0.3; } else
                 if (i==8) { iX=iX+0.3; }
              //#--------------------------
                 if (j==7) { jX=jX-0.3; } else
                 if (j==8) { jX=jX+0.3; }
              }
              //#--------------------------
...
{
    if (orientation==180)  { orientation=0; } else
    if (orientation<0)     { orientation=180-orientation; }  else
