...
const unsigned int noiseThreshold = 25; //pixels
                    ...
                    for (i=0; i<points.size()-1; i++)
                        {
                            if ( (points[i].x!=0) && (points[i].y!=0) )
                                {
                                    if (bbox->minimumX > points[i].x)
                                        {
                                            bbox->minimumX=points[i].x;
                                            bbox->populated=1;
                                        }
                                    if (bbox->maximumX < points[i].x)
                                        {
                                            bbox->maximumX=points[i].x;
                                            bbox->populated=1;
                                        }
                                    if (bbox->minimumY > points[i].y)
                                        {
                                            bbox->minimumY=points[i].y;
                                            bbox->populated=1;
                                        }
                                    if (bbox->maximumY < points[i].y)
                                        {
                                            bbox->maximumY=points[i].y;
                                            bbox->populated=1;
                                        }
                                }
                        }
