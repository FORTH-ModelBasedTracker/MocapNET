...
SYSTEM_DEPENDENCIES="python3-pip python3-venv wget git build-essential cmake unzip libopencv-dev libjpeg-dev libpng-dev libglew-dev libpthread-stubs0-dev"
#------------------------------------------------------------------------------
