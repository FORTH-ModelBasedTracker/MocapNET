...
struct MocapNET2Options
{
    ...
    unsigned int forceFront,forceBack,forceLeft,forceRight;
    ...
    unsigned int visualize,useOpenGLVisualization,save3DVisualization,save2DVisualization,saveVisualization,saveCSV3DFile,keepIntermediateFiles,constrainPositionRotation;
