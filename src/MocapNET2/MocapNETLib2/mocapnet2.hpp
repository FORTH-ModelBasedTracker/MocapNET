...
#include "../../NeuralNetworkAbstractionLayer/neuralNetworkAbstraction.hpp"
...
struct MocapNET2SolutionPart
{
   ...
   //-----------------------------------------
   struct TensorflowInstance modelsOLD[16]; 

   struct neuralNetworkModel models[16]; 
   unsigned int mode;
...
struct MocapNET2
{
   ...
   unsigned int lhandSelectionIndexesArePopulated;
   unsigned int lhandSelectionIndexes[mocapNET_InputLength_WithoutNSDM_lhand];
   //python3 exportCPPCodeFromJSONConfiguration.py --front rhand --config dataset/rhand_configuration.json 
   unsigned int rhandSelectionIndexesArePopulated;
   unsigned int rhandSelectionIndexes[mocapNET_InputLength_WithoutNSDM_rhand];
   //TODO: add face here..
   //--------------------------------
