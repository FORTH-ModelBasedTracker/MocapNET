...
SYSTEM_DEPENDENCIES="build-essential python3-venv python3-pip freeglut3-dev libglew-dev" #The python code does not need these anymore.. (?) protobuf-compiler libprotobuf-dev libavdevice-dev
